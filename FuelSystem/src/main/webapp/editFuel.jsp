...
<p></p>
		<main class="login-form">
	        <div class="row justify-content-center">
	            <div class="col-md-8">
	                <div class="card">
	                    <div class="card-header" style="background-color:LightSkyBlue;">Edit order</div>
	                    <div class="card-body">
	                    <%
						...
						%>
	                        <form action="editFuel" method="post"><!--   id is hidden and for the same form data is filled and displayed-->
